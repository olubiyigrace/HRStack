...
import com.hrstack.respository.OtpRepository;
import com.hrstack.dto.requestDto.OtpRequest;
import com.hrstack.entitys.Otp;
...
public class OtpService {
    ...
    public String verifyOtp(OtpVerifyRequest otpVerifyRequest) {
        ...
        Optional<Otp> otpOptional = otpRepository.findByEmail(
